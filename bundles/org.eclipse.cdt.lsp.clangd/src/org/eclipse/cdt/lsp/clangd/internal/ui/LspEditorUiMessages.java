...
public class LspEditorUiMessages extends NLS {
	...
	public static String LspEditorPreferencePage_compilation_database_source_disabled;
	public static String LspEditorPreferencePage_compilation_database_source_manual;
	public static String LspEditorPreferencePage_compilation_database_source_automatic;
	public static String LspEditorPreferencePage_compilation_database_source_not_detected;
	public static String LspEditorPreferencePage_compilation_database_status_disabled;
	public static String LspEditorPreferencePage_compilation_database_status_manual_missing;
	public static String LspEditorPreferencePage_compilation_database_status_manual;
	public static String LspEditorPreferencePage_compilation_database_status_automatic_missing;
	public static String LspEditorPreferencePage_compilation_database_status_automatic;
	public static String LspEditorPreferencePage_compilation_database_status_parent_clangd;
	public static String LspEditorPreferencePage_compilation_database_status_not_detected;
