...
public class SwitchToLspBannerNewExperience extends SwitchToLspBanner {
	...
	public SwitchToLspBannerNewExperience(ITextEditor part) {
		super(part);
	}

	@Override
	protected String tryLspBannerLink() {
		return LinkHelper.SPARKLES + LinkHelper.A(Messages.SwitchToLsp_TryNewExperienceBannerLink)
				+ LinkHelper.LINK_SPACER + LinkHelper.getLinks(false);
	}
